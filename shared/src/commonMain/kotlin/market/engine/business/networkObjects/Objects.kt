...
data class Fields(
    ...
    @SerialName("choices") val choices: List<Choices>? = listOf(),
...
data class Offer(
    ...
    @SerialName("lastupdated_ts") val lastUpdatedTs: Long = 1,
    @SerialName("current_price_per_item") var currentPricePerItem: String? = null,
    @SerialName("buynow_price") val buyNowPrice: String? = null,
    ...
    @SerialName("free_location") val freeLocation: String? = null,
    ...
    @SerialName("relisting_mode") val relistingMode: RelistingMode? = null,
