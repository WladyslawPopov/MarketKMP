...
fun HomeNavigation(
    ...
    Children(
        ...
        when (val screen = child.instance) {
            is MainComponent.ChildHome.SearchChild -> SearchContent(screen.component, modifier)
            is MainComponent.ChildHome.ListingChild -> ListingContent(screen.component, modifier)
