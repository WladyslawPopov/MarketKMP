...
fun CreateOfferContent(
    ...
    val refresh = {
        val cURL = when(type){
            CreateOfferTypes.CREATE -> "categories/$categoryID/operations/create_offer"
            CreateOfferTypes.EDIT -> "offers/$offerId/operations/edit_offer"
            CreateOfferTypes.COPY -> "offers/$offerId/operations/copy_offer"
            CreateOfferTypes.COPY_WITHOUT_IMAGE -> "offers/$offerId/operations/copy_offer_without_old_photo"
            CreateOfferTypes.COPY_PROTOTYPE -> "offers/$offerId/operations/copy_offer_from_prototype"
        }
