...
data class User(
    @SerialName("id") val id: Long = 1L,
    @SerialName("owner") val owner: Long? = null,
    @SerialName("created_ts") val createdTs: Long? = null,
    @SerialName("lastupdated_ts") val lastUpdatedTs: Long? = null,
    @SerialName("login") val login: String? = null,
    @SerialName("rating") val rating: Int? = 0,
    @SerialName("is_verified") val isVerified: Boolean = false,
    @SerialName("rating_badge") val ratingBadge: RatingBadge? = null,
    @SerialName("last_active_ts") val lastActiveTs: Long? = null,
...
data class Order(
    ...
    @SerialName("suborders") var suborders: List<Offer> = listOf(),
    @SerialName("feedbacks") var feedbacks: Feedbacks? = null,
    @SerialName("marks") var marks: List<Marks>? = null,
    ...
    @SerialName("deal_type") var dealType: DealType? = null,
    @SerialName("delivery_address") var deliveryAddress: DeliveryAddress? = null,
    @SerialName("payment_method") var paymentMethod: PaymentMethod? = null,
    @SerialName("delivery_method") var deliveryMethod: DeliveryMethod? = null,
    @SerialName("total") val total: String? = null,
    @SerialName("refund_was_made") val refundWasMade: Boolean? = false,
)
